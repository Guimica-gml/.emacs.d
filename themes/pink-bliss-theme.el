...
;; Modified by: Guimica-gml
;; Tested and working on emacs 28.2
...
(custom-theme-set-faces
 ...
 '(fringe ((((min-colors 256)) (:background "pink"))))
 '(menu ((((min-colors 256)) (:background "pink" :foreground "violet red"))))
 '(mode-line ((((min-colors 256)) (:background "light pink" :foreground "purple"
                                               :box nil))))
 ...
 ;; line-number-mode
 '(line-number ((((min-colors 256)) (:foreground "dark gray" :background "misty rose"))))
 '(line-number-current-line ((((min-colors 256)) (:inherit line-number :foreground "deep pink" :bold t))))
 ;; isearch
 ...
 '(font-lock-preprocessor-face ((((min-colors 256)) (:foreground "deep pink"))))
